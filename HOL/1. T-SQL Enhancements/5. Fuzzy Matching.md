...
Next, you are about to use the new fuzzy string matching functions introduced in SQL Server 2025, such as `EDIT_DISTANCE` and `JARO_WINKLER_SIMILARITY`. These functions are currently classified as preview features, so they must first be enabled at the database level before they can be used:
...
▶ [Lab: Regular Expressions](https://github.com/lennilobel/sql2025-workshop-hol-orlando2026/blob/main/HOL/1.%20T-SQL%20Enhancements/6.%20Regular%20Expressions.md)
